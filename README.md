...
# Data Files
FSL-DCM_data.txt: Isothermal DC-magnetization (DCM) curve of sample FS-L from [4]. Column 1: magnetic field in [A/m], column 2: magnetization in [Am^2/kg_Fe], column 3: measurement uncertainty.\\
