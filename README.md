...
# Data Files
FSL-DCM_data.txt: Isothermal DC-magnetization (DCM) curve of sample FS-L from [4].

FSL-SAXS_data.txt: Small-angle X-ray scattering (SAXS) measurement of sample FS-L from [4].
# Notebooks
